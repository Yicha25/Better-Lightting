...
Integrated UI Controls: Adds controls directly into the GeoFS Advanced Settings menu for easy management.
...
# Steps
Install the Script Manager (e.g., Tampermonkey) if you haven't already.
